	...
	<div class="container">
		...
		<div class="menubar">
			<div class="nav flex-column nav-pills me-3" id="v-pills-tab"
				...
				<button class="nav-link active m-2" id="v-pills-messages-tab"
					data-bs-toggle="pill" data-bs-target="#v-pills-messages"
					type="button" role="tab" aria-controls="v-pills-messages"
					aria-selected="false">Add New Customer/Vehicle</button>
				...
				<div class="tab-pane fade show active" id="v-pills-messages"
					...
					<div class="twobtn">
						<div class="button-wrapper">
							<a href="custvehicleform" style="text-decoration: none; margin:0 auto;"><button type="button" class="btn btn-success btn-lg">Enter Details With Customer</button></a>
							<a href="vehicleform" style="text-decoration: none; margin:0 auto;"><button type="button" class="btn btn-secondary btn-lg">Enter Details Without Customer</button></a>
						</div>
					</div>
				</div>
