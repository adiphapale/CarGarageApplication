	...
	<div class="login-container">
		...
		<form:form name="frm" action="validadmin" method="Post"
			...
			<div class="input-group">
				...
				<input type="text" id="first" name="adminName"
					placeholder="Enter Admin name" maxlength="50" required>

			</div>
			<div class="input-group">

				<input type="password" id="password" name="adminPassword"
					placeholder="Enter Admin Password" maxlength="50" required>
			</div>
			<button type="submit" onclick="solve()">Log in</button>
		</form:form>
